...
static const char *lower_volume[] = { "pamixer", "-d", "5", NULL };
...
static const Key keys[] = {
    ...
    { NOMOD,                     XKB_KEY_XF86AudioLowerVolume,spawn, {.v = lower_volume}},
    { NOMOD,                     XKB_KEY_XF86AudioRaiseVolume,spawn, {.v = raise_volume}},
    { NOMOD,                     XKB_KEY_XF86AudioMute,       spawn, {.v = mute_volume}},
    { NOMOD,                     XKB_KEY_XF86AudioPlay,       spawn, {.v = player_play_pause}},
    { NOMOD,                     XKB_KEY_XF86AudioNext,       spawn, {.v = player_next}},
    { NOMOD,                     XKB_KEY_XF86AudioPrev,       spawn, {.v = player_prev}},
